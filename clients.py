...
def znajdz_klienta_po_imieniu_zwierzaka(klienci, imie_zwierzecia):
    ...
    imie_zwierzecia_normalized = usun_znaki_diakrytyczne(imie_zwierzecia)
    print(f"Normalized search name: {imie_zwierzecia_normalized}")
    for klient in klienci:
        imie_klienta_normalized = usun_znaki_diakrytyczne(klient['zwierze']['imie_zwierzecia'])
        if imie_klienta_normalized == imie_zwierzecia_normalized:
...
def wyszukaj_pacjenta(klienci):
    while True:
        ...
        if imie_lub_id.isdigit():
            klient_id = normalizuj_id(imie_lub_id)
            klient = znajdz_klienta_po_id(klienci, klient_id)
            if klient:
            ...
            znalezione_zwierzaki = znajdz_klienta_po_imieniu_zwierzaka(klienci, imie_lub_id)
            print(f"Wyszukiwanie dla imienia: {imie_lub_id}")
            print(f"Znalezione zwierzaki: {[klient['zwierze']['imie_zwierzecia'] for klient in znalezione_zwierzaki]}")
            ...
            if len(znalezione_zwierzaki) > 1:
                ...
                while True:
                    ...
                    try:
                        klient = znajdz_klienta_po_id(klienci, wybor)
